...
#define BP35_RST_Pin GPIO_PIN_0
#define BP35_RST_GPIO_Port GPIOB
...
#define LED_CAN_1_Pin GPIO_PIN_7
#define LED_CAN_1_GPIO_Port GPIOC
#define LED_CAN_2_Pin GPIO_PIN_8
#define LED_CAN_2_GPIO_Port GPIOC
#define LED_CAN_3_Pin GPIO_PIN_9
