...
* 不要な単語を切り捨てる：convert_to_string → to_string
* 一貫性を保つ
* 誤解されない名前を選ぶ
...
* **標準略語は許可:** 誤解を生まず、広く知られる略語は、許可します。
    * 許可例: `PWM`, `ID`, `CAN`, `IMU`, `PID`, `LED`, `USB`, `IP`, `GPIO`, `UART`, `SPI`, `I2C`, `RGB`
    * クラス名の場合はCanやPidとはせず、CANやPIDのようにすべて大文字とし、省略されていることがわかるようにしてください。
...
* **UML図:** 複雑なクラスやモジュールには、UML図を追加して理解を助けてください。

## 5. 行動規範 (Behavioral Rules)
